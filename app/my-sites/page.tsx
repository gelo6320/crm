                  ...
                  >
                    ...
                    <div className="relative bg-black">
                      ...
                      <a 
                        ...
                        className="absolute bottom-3 right-3 bg-primary hover:bg-primary-hover p-2 rounded-full text-white shadow-lg transition-all hover:scale-105 relative z-10"
                      ...
                      <div className="flex">
                        ...
                        <div className="w-64 bg-black relative flex-shrink-0">
                          ...
                          <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="absolute bottom-3 right-3 bg-primary hover:bg-primary-hover p-2.5 rounded-full text-white shadow-lg transition-all hover:scale-105 relative z-10"
                            title="Visita il sito"
                            onClick={(e) => e.stopPropagation()}
                          >
                            <ExternalLink size={16} />
